...
import { Movie, Tv, UserQuery } from "../graphql";

export default function Seen({ item, date }: { item: UserQuery['user']['watched']['watched'][0]['item'], date?: number | Date }) {
  ...
  return (
    <Card className="card-watched">
      ...
      <div className="p-3 text-left title">
        ...
        {date && <p className="bp3-text-small card-watched-muted">
